...
def main():
	number_of_users, min_passwd_length, max_passwd_length = NUMBER_OF_USERS, MIN_PASSWD_LENGTH, MAX_PASSWD_LENGTH

	try: number_of_users = int(input(f'Enter the NUMBER OF USERS:  '))
	except Exception as e: print(f'{e}..... USING DEFAULT VALUE {NUMBER_OF_USERS}')

	try: min_passwd_length = int(input(f'Enter the MINIMUM PASSWORD LENGTH:  '))
	except Exception as e: print(f'{e}..... USING DEFAULT VALUE {MIN_PASSWD_LENGTH}')

	try: max_passwd_length = int(input(f'Enter the MAXIMUM PASSWORD LENGTH:  '))
	except Exception as e: print(f'{e}..... USING DEFAULT VALUE {MAX_PASSWD_LENGTH}')
